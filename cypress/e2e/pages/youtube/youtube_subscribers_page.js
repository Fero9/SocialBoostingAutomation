export class YouTubeSubscribersPage{

    youtube_subscribers_page_heading = '.elementor-element-7ee7e59 > .elementor-widget-container > .elementor-heading-title'
    youtube_subscribers_page_paragraph = '.elementor-element-94984d4 > .elementor-widget-container > p'

    youtube_subscribers_page_likes_service = '#menu-1-94da795 > .menu-item-3265 > .elementor-item'
    youtube_subscribers_page_views_service = '#menu-1-94da795 > .menu-item-3268 > .elementor-item'
    youtube_subscribers_page_comments_service = '#menu-1-94da795 > .menu-item-3264 > .elementor-item'
    ...
    checkYouTubeHighQualitySubscribersPackages(){
        //100 High Quality subscribers
        cy.get(this.youtube_subscribers_page_100_high_quality_subscribers_amount).should('contain', '100')
        cy.get(this.youtube_subscribers_page_100_high_quality_subscribers_price).should('contain','$7.48')
        //300 High Quality subscribers
        cy.get(this.youtube_subscribers_page_300_high_quality_subscribers_amount).should('contain', '300')
        cy.get(this.youtube_subscribers_page_300_high_quality_subscribers_price).should('contain','$18.98')
        //600 High Quality subscribers
        cy.get(this.youtube_subscribers_page_600_high_quality_subscribers_amount).should('contain', '600')
        cy.get(this.youtube_subscribers_page_600_high_quality_subscribers_price).should('contain','$34.50')
        //1,000 High Quality subscribers
        cy.get(this.youtube_subscribers_page_1000_high_quality_subscribers_amount).should('contain', '1,000')
        cy.get(this.youtube_subscribers_page_1000_high_quality_subscribers_price).should('contain','$57.50')
        //1,500 High Quality subscribers
        cy.get(this.youtube_subscribers_page_1500_high_quality_subscribers_amount).should('contain', '1,500')
        cy.get(this.youtube_subscribers_page_1500_high_quality_subscribers_price).should('contain','$82.80')
        //2,500 High Quality subscribers
        cy.get(this.youtube_subscribers_page_2500_high_quality_subscribers_amount).should('contain', '2,500')
        cy.get(this.youtube_subscribers_page_2500_high_quality_subscribers_price).should('contain','$135.70')
        //4,000 High Quality subscribers
        cy.get(this.youtube_subscribers_page_4000_high_quality_subscribers_amount).should('contain', '4,000')
        cy.get(this.youtube_subscribers_page_4000_high_quality_subscribers_price).should('contain','$207.00')
        //6,000 High Quality subscribers
        cy.get(this.youtube_subscribers_page_6000_high_quality_subscribers_amount).should('contain', '6,000')
        cy.get(this.youtube_subscribers_page_6000_high_quality_subscribers_price).should('contain','$287.50')
        //10,000 High Quality subscribers
        cy.get(this.youtube_subscribers_page_10000_high_quality_subscribers_amount).should('contain', '10,000')
        cy.get(this.youtube_subscribers_page_10000_high_quality_subscribers_price).should('contain','$402.50')
    }

    checkYouTubePremiumSubscribersPackages(){
        //100 Premium subscribers
        cy.get(this.youtube_subscribers_page_100_premium_subscribers_amount).should('contain', '100')
        cy.get(this.youtube_subscribers_page_100_premium_subscribers_price).should('contain','$8.60')
        //300 Premium subscribers
        cy.get(this.youtube_subscribers_page_300_premium_subscribers_amount).should('contain', '300')
        cy.get(this.youtube_subscribers_page_300_premium_subscribers_price).should('contain','$21.83')
        //600 Premium subscribers
        cy.get(this.youtube_subscribers_page_600_premium_subscribers_amount).should('contain', '600')
        cy.get(this.youtube_subscribers_page_600_premium_subscribers_price).should('contain','$39.68')
        //1,000 Premium subscribers
        cy.get(this.youtube_subscribers_page_1000_premium_subscribers_amount).should('contain', '1,000')
        cy.get(this.youtube_subscribers_page_1000_premium_subscribers_price).should('contain','$66.13')
        //1,500 Premium subscribers
        cy.get(this.youtube_subscribers_page_1500_premium_subscribers_amount).should('contain', '1,500')
        cy.get(this.youtube_subscribers_page_1500_premium_subscribers_price).should('contain','$95.22')
        //2,500 Premium subscribers
        cy.get(this.youtube_subscribers_page_2500_premium_subscribers_amount).should('contain', '2,500')
        cy.get(this.youtube_subscribers_page_2500_premium_subscribers_price).should('contain','$156.06')
        //4,000 Premium subscribers
        cy.get(this.youtube_subscribers_page_4000_premium_subscribers_amount).should('contain', '4,000')
        cy.get(this.youtube_subscribers_page_4000_premium_subscribers_price).should('contain','$238.05')
        //6,000 Premium subscribers
        cy.get(this.youtube_subscribers_page_6000_premium_subscribers_amount).should('contain', '6,000')
        cy.get(this.youtube_subscribers_page_6000_premium_subscribers_price).should('contain','$330.63')
        //10,000 Premium subscribers
        cy.get(this.youtube_subscribers_page_10000_premium_subscribers_amount).should('contain', '10,000')
        cy.get(this.youtube_subscribers_page_10000_premium_subscribers_price).should('contain','$462.88')
    }
